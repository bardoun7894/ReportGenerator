                              ...
                              <div className="rounded-2xl overflow-hidden" style={{ backgroundColor: colors.light }}>
                                                                      ...
                                                                      <div className="bg-white rounded-2xl p-4 shadow-sm">
                                                                                ...
                                                                                <div className="flex flex-wrap gap-2 pr-13">
                                                                                          {formData.targetAudience.map((a, i) => (
                                                                                                    <span key={i} className="inline-flex items-center justify-center px-4 py-1.5 rounded-2xl text-sm font-semibold text-white whitespace-nowrap" style={{ background: `linear-gradient(135deg, ${colors.secondary}, #F97316)` }}>{getAudienceLabel(a)}</span>
                                                                                          ))}
                                                                                </div>
                                                                      </div>
                                                            )}
                                                                                ...
                                                                                <ul className="space-y-3 pr-13">
                                                                                          {formData.objectives.map((obj, idx) => (
                                                                                                    <li key={idx} className="flex items-start gap-3 text-sm text-slate-600">
                                                                                                              <span className="w-6 h-6 rounded-full flex items-center justify-center text-xs text-white font-bold flex-shrink-0 mt-0.5" style={{ background: `linear-gradient(135deg, ${colors.secondary}, #F97316)` }}>
                                        ...
                                        <div style={{ background: `linear-gradient(90deg, ${colors.primary} 0%, ${colors.secondary} 100%)`, padding: '24px 32px' }}>
                                                  ...
                                                  <div className="flex justify-center gap-16">
                                                            {formData.principalName && <div className="text-center"><p className="text-white/60 text-xs mb-1">مدير/ة المدرسة</p><p className="text-white font-semibold">{formData.principalName}</p></div>}
                                                            {formData.activityLeaderName && <div className="text-center"><p className="text-white/60 text-xs mb-1">رائد/ة النشاط</p><p className="text-white font-semibold">{formData.activityLeaderName}</p></div>}
                                                  </div>
                                        </div>
                              </div>
                    </div>
