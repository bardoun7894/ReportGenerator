                                                                      ...
                                                                      <div className="bg-white rounded-2xl p-4 shadow-sm hover:shadow-md transition-shadow">
                                                                                ...
                                                                                <div className="flex flex-wrap gap-2 pr-11">
                                                                                          {formData.targetAudience.map((a, i) => (
                                                                                                    <span key={i} className="px-3 py-1 rounded-full text-sm" style={{ backgroundColor: colors.accent, color: colors.primary }}>{a}</span>
                                                                                          ))}
                                                                                </div>
                                                                      </div>
                                                            )}
                                                                                ...
                                                                                <ul className="space-y-2 pr-11">
                                                                                          {formData.objectives.map((obj, idx) => (
                                                                                                    <li key={idx} className="flex items-start gap-2 text-sm text-slate-600">
                                                                                                              <span className="w-5 h-5 rounded-full flex items-center justify-center text-xs text-white flex-shrink-0 mt-0.5" style={{ backgroundColor: colors.secondary }}>{idx + 1}</span>
