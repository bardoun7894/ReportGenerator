...
export default function TemplateForestGreen({ formData, reportTypeTitle }: TemplateProps) {
          const colors = {
                    primary: '#1B4332',
                    secondary: '#40916C',
                    accent: '#95D5B2',
                                                  ...
                                                  <div className="space-y-4">
                                                            <div className="bg-white rounded-2xl p-4 shadow-sm hover:shadow-md transition-shadow">
                                                                      <div className="flex items-center gap-3 mb-2">
                                                                                <div className="w-8 h-8 rounded-full flex items-center justify-center" style={{ backgroundColor: colors.accent }}>
                                                                                          <CalendarDaysIcon className="w-4 h-4" style={{ color: colors.primary }} />
                                                                                </div>
                                                            ...
                                                            {formData.participantsCount && (
                                                                      <div className="bg-white rounded-2xl p-4 shadow-sm hover:shadow-md transition-shadow">
                                                                                <div className="flex items-center gap-3 mb-2">
                                                                                          <div className="w-8 h-8 rounded-full flex items-center justify-center" style={{ backgroundColor: colors.accent }}>
                                                                                                    <UsersIcon className="w-4 h-4" style={{ color: colors.primary }} />
                                                                                          </div>
                                                                                          <span className="text-sm font-semibold" style={{ color: colors.primary }}>عدد المشاركين</span>
                                                                                </div>
                                                                                <p className="text-2xl font-bold pr-11" style={{ color: colors.secondary }}>{formData.participantsCount}</p>
                                                                      </div>
                                                            )}
                                                                      ...
                                                                      <div className="bg-white rounded-2xl p-4 shadow-sm hover:shadow-md transition-shadow">
                                                                                ...
                                                                                <div className="flex flex-wrap gap-2 pr-11">
                                                                                          {formData.targetAudience.map((a, i) => (
                                                                                                    <span key={i} className="inline-flex items-center justify-center px-3 py-1 rounded-full text-sm whitespace-nowrap" style={{ backgroundColor: colors.accent, color: colors.primary }}>{getAudienceLabel(a)}</span>
                                                                                          ))}
                                                                                </div>
                                                                      </div>
                                                            )}
                                                            ...
                                                            {formData.objectives && formData.objectives.length > 0 && (
                                                                      <div className="bg-white rounded-2xl p-4 shadow-sm hover:shadow-md transition-shadow">
                                                                                <div className="flex items-center gap-3 mb-3">
                                                                                          <div className="w-8 h-8 rounded-full flex items-center justify-center" style={{ backgroundColor: colors.accent }}>
                                                                                                    <FlagIcon className="w-4 h-4" style={{ color: colors.primary }} />
                                                                                          </div>
                                                                                ...
                                                                                <ul className="space-y-2 pr-11">
                                                                                          {formData.objectives.map((obj, idx) => (
                                                                                                    <li key={idx} className="flex items-start gap-2 text-sm text-slate-600">
                                                                                                              <span className="w-6 h-6 rounded-full flex items-center justify-center text-sm text-white flex-shrink-0" style={{ backgroundColor: colors.secondary }}>
                                                  ...
                                                  <div className="space-y-4">
                                                            {formData.photos && formData.photos.length > 0 ? (
                                                                      formData.photos.slice(0, 3).map((photo, idx) => (
                                                                                <div key={idx} className="bg-white rounded-2xl overflow-hidden shadow-sm hover:shadow-md transition-shadow relative aspect-video">
